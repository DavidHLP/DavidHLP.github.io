...
> **我：** 面试官好，我是大二软件相关专业的学生，主攻Java后端方向。比较熟悉常用的中间件和底层数据库。最近主要做了一个基于 Spring Cache 二次开发的工具库，重点做了 Redis 相关的业务优化。
...
> **Q5：看你还有一个校园内网（兴趣班反馈）项目，里面用到了 ECharts 和 MySQL 多维度统计，具体是怎么做的？**
