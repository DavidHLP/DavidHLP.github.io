---
title: "ResiCache 项目总览：README 与 README.zh-CN 固定提交快照"
capturedAt: 2026-08-21 00:00:00+08:00
sourceType: repository-readme-fixed-commit
sourceUrl: "https://github.com/DavidHLP/ResiCache/tree/75ed279a71b17f227c3170d738eb93e50d876c8a"
immutable: true
tags: [ResiCache, SpringCache, Redis, ResponsibilityChain, CacheProtection]
description: "以 ResiCache 公开 main 提交 75ed279a 固定 README.md（canonical）与 README.zh-CN.md 原文：@RedisCacheable 防护注解、责任链 handler 顺序、配置边界、已知限制与 Not in Scope。"
---

# ResiCache 项目总览快照

本文件为证据快照（immutable raw），原样收录仓库 README，不改动正文，仅增加 provenance 头部与分隔。后续 wiki 页通过 `sources` 引用本快照。

- raw slug: `resicache-project-overview`
- 对应 wiki: `resicache`
- 固定提交: `75ed279a71b17f227c3170d738eb93e50d876c8a`（`https://github.com/DavidHLP/ResiCache/tree/75ed279a71b17f227c3170d738eb93e50d876c8a`）
- 捕获方式: 本地克隆 `git show <commit>:<path>` 提取，逐字拼接；该提交即当前 origin/main HEAD。
- 边界说明: 本地工作区在该提交之后存在未发布修改（领先 origin/main 14 个提交），不作为本快照证据；README 声明英文版为 canonical。

## 来源清单

| 序号 | 文件 | 说明 |
| --- | --- | --- |
| 1 | `README.md` | 英文 canonical README |
| 2 | `README.zh-CN.md` | 中文 README（声明可能滞后于英文版） |

## 免责与边界

- README 声明项目为 v0.0.2 早期、Non-SLA best-effort、单人维护；配置默认值与兼容矩阵以固定提交时的 COMPATIBILITY.md 为准，本快照未收录。
...
- 原始 URL: <https://github.com/DavidHLP/ResiCache/blob/75ed279a71b17f227c3170d738eb93e50d876c8a/README.md>
- 本地路径: `README.md`
...
## 来源 2: `README.zh-CN.md`

- 原始 URL: <https://github.com/DavidHLP/ResiCache/blob/75ed279a71b17f227c3170d738eb93e50d876c8a/README.zh-CN.md>
- 本地路径: `README.zh-CN.md`
