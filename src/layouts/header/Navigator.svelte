...
{#each routes as item}
	...
	<a href={item.path} onclick={handleClose} class="relative inline-flex items-center group" class:max-sm:font-bold={isActive} aria-current={isActive ? "page" : undefined}>
...
<style>
	.navigation-links { display: contents; }
</style>
